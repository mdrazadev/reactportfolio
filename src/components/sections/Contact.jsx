        ...
        <RevealOnScroll>
            <div className="px-4 w-150">
                ...
                <form action="" className="space-y-6">
                    ...
                    <div className="relative">
                        <textarea row={5} id="message" name="message" required placeholder="Description..." className="w-full bg-white/5 border border-white/10 rounded px-4 py-3 text-white transition focus:outline-none focus:border-blue-500 focus:bg-blue-500/5" />
                    </div>
